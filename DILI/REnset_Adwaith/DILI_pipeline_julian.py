...
import sys
import gc
from tensorflow.keras.layers import BatchNormalization, Conv1D, AveragePooling1D, MaxPooling1D, ZeroPadding1D, Activation, Dense, Flatten
from tensorflow.keras.models import Model
from tensorflow.keras.layers import add, Input, Reshape
...
def train_predict(X_train, X_test, y_train, y_test, model_no, lossf, kernel_size, stages, filters, stride, fc_layers, activation,\
    optimizer, reg, batch_size, epochs):
...
kernel_size = [9] #15
stages_filters = [[[3], [9, 18]] ] #[[3], [18, 18]], [[3], [18, 36]], [[3, 3], [9, 9, 18]], [[3, 3], [9, 18, 36]], [[3, 3], [18, 18, 36]], [[3, 3], [18, 36, 72]], [[3, 3, 3], [
    #9, 18, 36, 72]], [[3, 3, 3, 3], [9, 9, 18, 36, 72]]
stride = [1]
fc_layers = [970]
activation = ['relu'] #, 'sigmoid'
reg = [0.0001]
optimizer = [Adam(learning_rate=0.00001)]
batch_size = [10] #, 30, 47, 60
epochs = [250]
...
with open('Results_large.csv', 'w', newline='') as csvfile:
